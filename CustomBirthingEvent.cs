...
namespace FamilyPlanning
{
    class CustomBirthingEvent : FarmEvent, INetObject<NetFields>
    {
        ...
        public NetFields NetFields { get; } = new NetFields("DO:WE:NEED:NAME");
        ...
        public bool setUp()
        {
            ...
            message = !spouse.isAdoptionSpouse() ? (spouse.Gender != 0 ? Game1.content.LoadString("Strings\\Events:BirthMessage_SpouseMother", Lexicon.getGenderedChildTerm(isMale), spouse.displayName) : Game1.content.LoadString("Strings\\Events:BirthMessage_PlayerMother", Lexicon.getGenderedChildTerm(isMale))) : Game1.content.LoadString("Strings\\Events:BirthMessage_Adoption", Lexicon.getGenderedChildTerm(isMale));
        ...
        public bool tickUpdate(GameTime time)
        {
            ...
            else if (getBabyName)
            {
                ...
                if (babyName != null && babyName != "" && babyName.Length > 0)
                {
                     ...
                     */
                    Child child = new(babyName, isMale, isDarkSkinned, Game1.player)
                    {
                        Age = 0,
                    ...
                    if (s == "")
                    {
                        if (Game1.player.getSpouse().isAdoptionSpouse())
                        {
