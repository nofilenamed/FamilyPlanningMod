                ...
                try
                {
                    ...
                    foreach (string key in cpdata.ChildSpriteID.Keys)
                    {
                        if (key.Equals(childName))
                        {
                            ...
                            var assetName1 = helper.ModContent.GetInternalAssetName("assets/" + pair.Item1).Name;
                            var assetName2 = helper.ModContent.GetInternalAssetName("assets/" + pair.Item2).Name;
